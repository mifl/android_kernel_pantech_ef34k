...
#if defined(FEATURE_PANTECH_MDS_MTC) || defined(FEATURE_PANTECH_STABILITY)
#ifdef CONFIG_COMPAT 
...
#if defined(FEATURE_PANTECH_STABILITY)
static struct miscdevice pantech_stability_misc = {
	.fops		= &uinput_fops,
	.minor		= UINPUT_MINOR + 2,
	.name		= "pantech_stability",//UINPUT_NAME,
};
#endif /* FEATURE_PANTECH_STABILITY */

static int __init uinput_init(void)
{
#if defined(FEATURE_PANTECH_MDS_MTC)
	misc_register(&uinput_mtc_misc);
#endif /* FEATURE_PANTECH_MDS_MTC */
#if defined(FEATURE_PANTECH_STABILITY)
	misc_register(&pantech_stability_misc);
#endif /* FEATURE_PANTECH_STABILITY */
...
#if defined(FEATURE_PANTECH_STABILITY)
	misc_deregister(&pantech_stability_misc);
#endif /* FEATURE_PANTECH_STABILITY */
#if defined(FEATURE_PANTECH_MDS_MTC)
